...
<body>
	<div class="easyui-layout" data-options="fit:true" >
		<div id="center" data-options="region:'center',border:false"
			style="padding:5px;">
			<div id="planPanel" title="编辑限免图书" class="easyui-panel"
				data-options="border:true" style="padding:5px;">
				<form id="modForm" name="modForm" method="post"
					action="<%=contextPath%>/admin/free/mod" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		...
		function goback(){
			window.location.href='<%=contextPath%>/admin/free/list/';
		}	
