...
<head>
    ...
    <script type="text/javascript">
		function submitForm(){
	    	...
	    	$("#addForm").attr("action","<%=contextPath %>/admin/vote/ipadd");	    	
	    	$('#addForm').submit();
	    }
...
<body class="easyui-layout" fit="true">
	<div region="center" id="center" style="padding:10px;" border="false">		
		<div class="easyui-panel" title="投票IP黑名单增加" style="width:750px;height:auto">			
			<form id="addForm" name="addForm" method="post" action="">
			<table class="promodify" cellspacing="1">
				<tr>
					<td class="info">限制IP：</td>
					<td>
						<input type="text" id="ip" name="ip" class="input-text easyui-textbox" data-options="required:true"/>
					</td>
				</tr>
			</table>
			</form>		
