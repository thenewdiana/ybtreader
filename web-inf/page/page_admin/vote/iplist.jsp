    ...
    <script type="text/javascript">
		$(function(){
			$("#list").datagrid({
			    ...
			    striped: true, 
			    singleSelect:true,
			    url:'<%=contextPath%>/admin/vote/iplist_json',
                columns:[[  
	                {field:'id',title:'ID',width:80},  
              		{field:'ip',title:'IP',width:280},  
            	]]
			});
		});
