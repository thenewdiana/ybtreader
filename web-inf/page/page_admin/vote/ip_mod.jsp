...
<head>
	...
	<script type="text/javascript">
		function submitForm(){
	    	...
	    	$("#modForm").attr("action","<%=contextPath %>/admin/vote/ipmod");	    	
	    	$('#modForm').submit();
	    }
		
		function goback(){
			window.location = "<%=contextPath %>/admin/vote/iplist";	
		}
	</script>
</head>
...
<body class="easyui-layout" fit="true">
	<div region="center" id="center" style="padding:10px;" border="false">		
		<div class="easyui-panel" title="投票IP黑名单修改" style="width:750px;height:auto">			
			<form id="modForm" name="modForm" method="post" action="">
			<input type="hidden" name="id" size="40" value="${obj.id }" />
			<table class="promodify" cellspacing="1">
				<tr>
					<td class="info">限制IP：</td>
					<td>
						<input type="text" id="ip" name="ip" class="input-text easyui-textbox" value="${obj.ip }" data-options="required:true"/>
					</td>
				</tr>
			</table>
			</form>		
