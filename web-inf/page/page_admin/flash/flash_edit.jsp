...
<body class="easyui-layout" fit="true">
		...
		<div class="easyui-panel" title="修改" style="width:800px;height:auto">			
			...
			<table class="promodify" cellspacing="1">
				<tr>
					...
					<td>
						<input type="text" id="name" name="name" value="${flash.name}" class="input-text easyui-textbox" data-options="required:true"/>
					</td>
				</tr>
				...
				<tr>
					...
					<a href="${sessionScope.customUrl}${flash.flashPath}" target='_blank'>${flash.flashPath}</a>
	...
	<script type="text/javascript">
		...
		function submitForm(){
	    	...
	    	$("#editForm").attr("action","<%=contextPath %>/admin/flash/edit");
	    	$('#editForm').submit();
	    }
	</script>		
</body>
