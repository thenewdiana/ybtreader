  ...
  <section class="container">
    ...
    <div class="login">
      ...
      <form id="login_form" method="post" action="index.html">
        ...
        <p><input type="password" id="userPassword" name="userPassword" value="" placeholder="密码"></p>
        <p class="submit"><input type="submit" name="commit" value="登录" onclick="submitForm();"></p>
      </form>
    </div>
