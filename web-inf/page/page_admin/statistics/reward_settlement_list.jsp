...
<body>
	<div class="easyui-layout" data-options="fit:true">	
		<div id="north" title="搜索条件"  style="background-color: #E0ECFF;height:60px;"
	       ...
	       <form id="searchForm" name="searchForm" action="<%=contextPath%>/admin/statistics/reward_settlement_list_json" method="post">
	       	  <table>
		         <tr>
		           	<th>书名：</th>
		            ...
		            <auth:authenticator action="admin/statistics/exportRewardSettlement">
    ...
    <script type="text/javascript">
		$(function(){
			$("#list").datagrid({
			    ...
			    striped: true, 
			    singleSelect:true,
			    url:'<%=contextPath%>/admin/statistics/reward_settlement_list_json',
                columns:[[  
	                {field:'id',title:'书号',width:$(this).width()*0.05},  
              		...
              		{field:'saleBean',title:'打赏总糖豆',width:$(this).width()*0.1},
    	...
    	function settlement(bookId,dataId){
			...
			var ajaxUrl = "<%=contextPath%>/admin/statistics/reward_settlement";
			ajaxR(ajaxUrl,data,"此操作不可逆，确定要结算此书吗?");	
		}
		
		function exportExcel() {
			$("#searchForm").attr("action","<%=contextPath %>/admin/statistics/exportRewardSettlement");
			$("#searchForm").submit();
		}
