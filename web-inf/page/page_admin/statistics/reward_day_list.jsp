...
<body>
	<div class="easyui-layout" data-options="fit:true">	
		<div id="north" title="搜索条件"  style="background-color: #E0ECFF;height:0px;"
	       ...
	       <form id="searchForm" name="searchForm" action="<%=contextPath%>/admin/statistics/reward_day_list_json" method="post">
    ...
    <script type="text/javascript">
		$(function(){
			$("#list").datagrid({
			    ...
			    striped: true, 
			    singleSelect:true,
			    url:'<%=contextPath%>/admin/statistics/reward_day_list_json',
                columns:[[  
