...
<head>
    ...
    <script type="text/javascript">
		function submitForm(){
	    	...
	    	$("#addForm").attr("action","<%=contextPath %>/admin/activity/payDefaultadd");	    	
	    	$('#addForm').submit();
	    }
		
		function goback(){
			window.location = "<%=contextPath %>/admin/activity/payDefaultlist";	
		}
	</script>
</head>
	...
	<div region="center" id="center" style="padding:10px;" border="false">		
		<div class="easyui-panel" title="充值默认金额增加" style="width:750px;height:auto">			
			...
			<table class="promodify" cellspacing="1">
				<tr>
					<td class="info">充值默认金额：</td>
					<td>
						<input type="text" id="payValue" name="payValue" class="input-text easyui-textbox" data-options="required:true"/>元
					</td>
				</tr>
			</table>
			</form>		
