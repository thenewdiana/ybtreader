...
<body class="easyui-layout" fit="true">
	<div region="center" id="center" style="padding:10px;" border="false">		
		<div class="easyui-panel" title="公告增加" style="width:800px;height:auto">			
			...
			<table class="promodify" cellspacing="1">
				...
				<tr>
					<td class="info">标题：</td>
					<td>
						<input type="text" id="title" name="title" class="input-text easyui-textbox" data-options="required:true,validType:['length[1,99]']"/>
					</td>
				</tr>				
				<tr>
					<td class="info">描述：</td>
	...
	<script type="text/javascript">
		...
		function submitForm(){
	    	...
	    	$("#addForm").attr("action","<%=contextPath %>/admin/notice/add");	    	
	    	$('#addForm').submit();
	    }
