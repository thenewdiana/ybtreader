		...
		<div id="center" data-options="region:'center',border:false"
			...
			<div id="planPanel" title="添加会员" class="easyui-panel"
				...
				<form id="addForm" name="addForm" method="post"
					action="<%=contextPath%>/admin/user/admin_add">
					...
					<table class="promodify" cellspacing="1">
						...
						<tr>
							<td class="info">姓名：</td>
							<td><input type="text" id="realName" name="realName" class="easyui-textbox" data-options="required:true,validType:['length[2,15]']"/>
								<span class="notice"></span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="info">角色：</td>
							<td>
								<c:forEach items="${sysRoleList }" var="role"><input type="checkbox" name="roleId" value="${role.id }" />${role.name }</c:forEach><span id="notice" class="notice"></span>
							</td>
						</tr>
					</table>
					<div align="center">
