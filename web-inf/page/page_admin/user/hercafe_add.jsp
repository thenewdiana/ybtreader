...
<head>
    ...
    <script type="text/javascript">
		function submitForm(){
	    	...
	    	$("#addForm").attr("action","<%=contextPath %>/admin/hercafe/add");	    	
	    	$('#addForm').submit();
	    }
...
<body class="easyui-layout" fit="true">
	<div region="center" id="center" style="padding:10px;" border="false">		
		<div class="easyui-panel" title="小编增加" style="width:550px;height:auto">			
			...
			<table class="promodify" cellspacing="1">
				...
				<tr>
					<td class="info">专长：</td>
					<td>
						<input type="text" id="userMajor" name="userMajor" class="input-text easyui-textbox" data-options="required:true"/>
					</td>
				</tr>					 
			</table>
			</form>		
