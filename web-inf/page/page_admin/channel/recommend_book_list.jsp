...
<body>
	<div class="easyui-layout" data-options="fit:true">
        <div id="center" data-options="region:'center',border:false" width="90%">
        	...
        	<div id="buttons" class="toolbar-button">
	        	<auth:authenticator action='/admin/subject/rec_book_add_init'>
    ...
    <script type="text/javascript">
                ...
                columns:[[  
	                ...
	                {field:'bookName',title:'书籍名称',width:120},
              		...
              		{field:'oper', title:'操作', width:120, formatter:function(value,row,index){
	                       var id = row.id; 
	                       var link = '<auth:authenticator action='/admin/subject/rec_book_mod_init/'><a class="editClass" href="javascript:mod(' + id + ');">编辑</a> </auth:authenticator>';
        ...
        function add(){
        	location.href = "<%=contextPath%>/admin/subject/rec_book_add_init?subjectId="+${subjectId};
        }
		
		function mod(id){
		   	location.href = "<%=contextPath%>/admin/subject/rec_book_mod_init/" + id;
		}
