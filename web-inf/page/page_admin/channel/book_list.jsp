...
<body>
    ...
    <script type="text/javascript">
			...
			$("#bookList").datagrid({
                ...
                columns:[[  
	                ...
	                {field:'bookName',title:'书籍名称',width:120},
              		...
              		{field:'showWords',title:'显示描述字数',width:100},
              		...
              		{field:'oper', title:'操作', width:120, formatter:function(value,row,index){
	                       var id = row.id; 
	                       var link = '<auth:authenticator action='/admin/subject/book_mod_init/'><a class="editClass" href="javascript:mod(' + id + ');">编辑</a> </auth:authenticator>';
        ...
        function add(){
        	location.href = "<%=contextPath%>/admin/subject/book_add_init?subjectId="+${subjectId};
        }
		
		function mod(id){
		   	location.href = "<%=contextPath%>/admin/subject/book_mod_init/" + id;
		}
		
		function deleteBook(id){
		    var ajaxUrl = "<%=contextPath%>/admin/subject/book_del";
			ajaxR(ajaxUrl,"csbId="+id,"是否确定要删除此图书?");
		}  
