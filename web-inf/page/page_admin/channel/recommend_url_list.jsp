...
<body>
    ...
    <script type="text/javascript">
		$(function(){
			$("#bookList").datagrid({
                ...
                columns:[[  
	                ...
	                {field:'recommDesc',title:'推荐URL',width:120},
              		...
              		{field:'oper', title:'操作', width:120, formatter:function(value,row,index){
	                       var id = row.id; 
	                       var link = '<auth:authenticator action='/admin/subject/rec_url_mod/'><a class="editClass" href="javascript:mod(' + id + ');">编辑</a> </auth:authenticator>';
        ...
        function add(){
        	location.href = "<%=contextPath%>/admin/subject/rec_url_add_init?subjectId="+${subjectId};
        }
		
		function mod(id){
		   	location.href = "<%=contextPath%>/admin/subject/rec_url_mod_init/" + id;
		}
