		...
		<div id="center" data-options="region:'center',border:false"
			...
			<div id="planPanel" title="添加推荐图书" class="easyui-panel"
				...
				<form id="addForm" name="addForm" method="post"
					action="<%=contextPath%>/admin/subject/book_add" enctype="multipart/form-data">
					...
					<table class="promodify" cellspacing="1">
						...
						<tr>
							...
							<td>
								<input type="text" id="showTitleWords" name="showTitleWords" class="easyui-numberbox" data-options="required:true" value="6"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" id="showWords" name="showWords" class="easyui-numberbox" data-options="required:true" value="30"/>
							</td>
						</tr>
						<tr>
							<td class="info">排序：</td>
							<td><input type="text" id="sort" name="sort" class="easyui-numberbox" value="${maxSort}" data-options="required:true"/>
							</td>
						</tr>
					</table>
					<div align="center">
