...
<head>
	...
	<script type="text/javascript">
		function submitForm(){
	    	...
	    	$("#modForm").attr("action","<%=contextPath %>/admin/tags/mod");	    	
	    	$('#modForm').submit();
	    }
		
		function goback(){
			window.location = "<%=contextPath %>/admin/tags/list";	
		}
	</script>
</head>
