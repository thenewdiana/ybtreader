	...
	$(document).ready(function() {
		...
		$("#lkGetFreeGold").click(function() {
			...
			$.ajax({
				...
				dataType : "json",
				async:true,
				url : "${pageContext.request.contextPath }/activity/getnewbie",
...
<div>
	...
	<div class="top">
		...
		<div class="btitle">
		    ...
		    <div>
		    	<img src="${sessionScope.baseUrl}pc/images/activity/20160720/banner-1_02.png">
		    </div>
	    </div>
	    <div class="clear"></div>
	</div>
	<div class="bmain">
		...
		<div class="mainbody">
			<div>
				<div class="tab">
					<a href="a20160720"><img src="${sessionScope.baseUrl}pc/images/activity/20160720/btn1.png"></a>
				</div>
				<div class="tab">
					<a href="a20160727"><img src="${sessionScope.baseUrl}pc/images/activity/20160720/btn2-g.png"></a>
				</div>
				<div class="tab">
					<a href="a20160803"><img src="${sessionScope.baseUrl}pc/images/activity/20160720/btn3-g.png"></a>
				</div>
				<div class="clear"></div>
			</div>
			<div class="h30"></div>
			<div class="maininfo">
				<img src="${sessionScope.baseUrl}pc/images/activity/20160720/main1-1.png">
				<div class="get">
					<a href="javascript:void();" id="lkGetFreeGold"><img src="${sessionScope.baseUrl}pc/images/activity/20160720/get.png"></a>
				</div>
				<img src="${sessionScope.baseUrl}pc/images/activity/20160720/main1-3.png">
			</div>
			<div id="footer">
				...
				<div class="clear"></div>
				<div id="icp">
					Copyright 2017 雁北堂中文网 版权所有 京ICP证161342号
				</div>
			</div>
		</div>
	</div>
