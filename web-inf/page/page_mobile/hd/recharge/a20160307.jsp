...
.topmenu {
	background-image: url(${sessionScope.baseUrl}pc/images/activity/20160307/title.png);
    wwidth: 190px;
    wheight: 30px;
    float: right;
...
<div class="a20160307">
	...
	<div class="a1dep"></div>
	<div class="a1">
		<a href="../recharge?recharge_value=10&channel=3"><img class="imga1" src="${sessionScope.baseUrl}pc/images/activity/20160307/a1.png"/></a>
		<div class="date">2016年03月08日——03月18日</div>
	</div>
	<div class="h15"></div>
	<div>
            <div class="recharge1">
            	<a target="_blank" href="../recharge?recharge_value=10&channel=3">
        ...
        <div class="info">
	        ...
	        <div class="adetail">
	        	...
	        	<div>
	        		<div class="no">4</div>
	        		赠送糖豆根据用户在活动期间的充值总金额进行计算，活动结束后一周内将发送至充值账户</div>
