...
<title>女生小说_女性小说_言情小说_奇幻小说-雁北堂中文网</title>
<meta name="keywords" content="女生小说,女性小说,言情小说,好看的女生小说，言情小说,奇幻小说 "></meta>
<meta name="description" content="雁北堂中文网女生频道提供言情小说，言情小说、奇幻小说等好看的女生小说推荐，方便读者在线阅读各类女生小说。"></meta>
...
<jsp:include page="../banner.jsp">
	 <jsp:param name="menu" value="channel_women"/>   
</jsp:include>
<!--中间-->
<div class="body-bg">
	<div class="w1000">
            ...
            <div class="wd-244 fr bords mt15">
                ...
                <div class="ce-c">
                    <ul class="new-list5 hide">
                        <c:forEach items="${bookRankMap['womenChannelRankByWeekList'] }" var="item" varStatus="status">
                            <%@ include file="../rank/sub_rank_click.jsp"%>
                       </c:forEach>
                    </ul>
					<ul class="new-list5 hide">
						<c:forEach items="${bookRankMap['womenChannelRankByMonthList'] }" var="item"
							varStatus="status">
							<%@ include file="../rank/sub_rank_click.jsp"%>
						</c:forEach>
					</ul>
					<ul class="new-list5 show">
                    	<c:forEach items="${bookRankMap['womenChannelRankByAllList'] }" var="item" varStatus="status">
                        	<%@ include file="../rank/sub_rank_click.jsp"%>
                         </c:forEach>
                    </ul>
				</div>
        ...
        <div class="bords mt10">
        	<div class="nv-sec3 over">
        		<c:forEach items="${subjectMap['three']}" var="item" varStatus="status">
        			<dl>
	                    <dt class="bords"><a href="${contextPath }/book/${item.bookId}" target="_blank"><img src="${item.bookBigImage}" onerror="this.src='${item.errorBigImage}'" width="174" height="229"/></a></dt>
	                    <dd>
	                        <h2 class="f14"><a href="${contextPath }/book/${item.bookId}" target="_blank">${item.bookShortRecommTitle}</a></h2>
            ...
            <div class="nv-sec4 over">
            	<c:forEach items="${subjectMap['four']}" var="item" varStatus="status">
            		<dl <c:if test="${status.count==6}">class="mrno"</c:if>>
	                	<dt><a href="${contextPath }/book/${item.bookId}" target="_blank"><img src="${item.bookBigImage}" onerror="this.src='${item.errorMidImage}'" width="118" height="148"/></a></dt>
	                    <dd>${item.bookShortRecommDec}</dd>
	                </dl>
		       	</c:forEach>
            </div>
