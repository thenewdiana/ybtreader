...
<body>  
 <div class="f-body">
    ...
    <div><img src="${sessionScope.baseUrl}pc/images/hd/hongbao/img/img2.jpg" alt="" width="1053" height="440" usemap="#Map" border="0" />
      <map name="Map" id="Map">
        <area shape="rect" coords="261,43,817,406" href="<%=contextPath %>/acitivity/red/get" />
      </map>
    </div>
