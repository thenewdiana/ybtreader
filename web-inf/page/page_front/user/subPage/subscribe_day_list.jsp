...
<form action="" id="subscribeForm" method="post">
	...
	<input type="hidden" id="statisticalDate" name="statisticalDate" value="${statisticalDate}" />
	...
	<div class="ce-t1 ce-t2">
		<c:forEach items="${bookList}" var="item" varStatus="status">
			<ul>
				...
				<li class="wd3">${item.statisticalDate}</li>
				<li class="wdl red">${item.saleBean}&nbsp;</li>
				<li class="wdl red">${item.sales}&nbsp;</li>
				<li class="wd3 red">${item.saleCount}&nbsp;</li>
			</ul>
		</c:forEach>
	</div>
	 <!--分页-->
...
function recPaper(pageNoValue, pageSizeValue) {
	openSubscribeDaySelect(pageNoValue, pageSizeValue,$("#statisticalDate").val());
}
</script>		
