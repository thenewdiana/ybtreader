...
<title><spring:message code="front.global.title"></spring:message>-用户管理中心-新建作品</title>
            ...
            <div class="u-perrg">
                ...
                <div class="ce3 ce10 wd12 pos_r">
                	...
                	<ul>
                        ...
                        <li class="mgwd">
                        	<label>是否申请签约</label>                        	
                            <input name="isPermission" type="radio" value="0" checked="checked" />
                            <span>否</span>
                            <input name="isPermission" type="radio" value="1" />
                            <span>是</span>
                    ...
                    <div id="imgdiv" class="picture ac">
                    	<img id="imgShow" src="${sessionScope.customUrl}book/bimgs/default_book.jpg" width="220" height="289" alt=""  class="bords"/>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("input[name='btn_submit']").bind("click", function() {
            if(validateDate()){
                $("#bookForm").attr("action", "${pageContext.request.contextPath }/author/book/add");
                $("#bookForm").submit();
            }
		});
	});
