...
<div class="ce3 ce10 wd12 pos_r sub11">
	...
	<input type="hidden" class="wd1" name="id" value="${bookSection.id }">
	<input type="hidden" class="wd1" name="bookId" value="${bookId }">
    <ul>
        <li>
            <label>分卷名称</label>
            <div class="w300 fl">
                <input type="text" class="wd1" name="sectionName" value="${bookSection.sectionName }">
        ...
        <li class="wd5">
            <label>分卷介绍</label>
            <div class="fl">
                <textarea class="wd4" name="sectionInfo">${bookSection.sectionInfo }</textarea>
                <div class="over wd6">
...
$(formObj).find("input[name='btn_submit']").bind("click", function() {
	...
	var formAction = "${pageContext.request.contextPath }/author/booksection/mod";
	$.ajax({
		type : "POST",
		dataType : "json",
		data : formData,
